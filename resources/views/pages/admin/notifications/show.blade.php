        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex gap-2">
                @if ($notification->read_at)
                    <form method="POST" action="{{ route('admin.notifications.mark-as-unread', $notification) }}">
                        @csrf
                        @method('PATCH')
                ...
                @else
                    <form method="POST" action="{{ route('admin.notifications.mark-as-read', $notification) }}">
                        @csrf
                        @method('PATCH')
                ...
                @endif
                <a href="{{ route('admin.notifications.index') }}" class="rounded-lg border border-gray-300 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:text-gray-300 dark:hover:bg-gray-800">Voltar</a>
            </div>
        </div>
