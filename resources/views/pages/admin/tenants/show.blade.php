...
@section('content')
    <div class="mx-auto max-w-3xl space-y-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-semibold text-gray-800 dark:text-white/90">Detalhes do Tenant</h1>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Visualize os dados cadastrais do tenant.</p>
            </div>
