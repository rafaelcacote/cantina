    ...
    <div class="mx-auto max-w-4xl space-y-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Cadastre um aluno para tenant e escola.</p>
            </div>
        ...
        <form method="POST" action="{{ route('admin.students.store') }}" class="space-y-5 rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
            @csrf

            @include('pages.admin.students.partials.form', [
                'student' => null,
                'tenants' => $tenants,
                'schools' => $schools,
