...
@section('content')
    <div class="mx-auto max-w-3xl space-y-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-semibold text-gray-800 dark:text-white/90">Detalhes do Usuário</h1>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Visualize os dados cadastrais do usuário.</p>
            </div>
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
            <dl class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                <div>
                    ...
                    <dd class="mt-1 text-sm font-medium text-gray-800 dark:text-white/90">{{ $user->name }}</dd>
                </div>
                <div>
                    <dt class="text-xs uppercase tracking-wide text-gray-500 dark:text-gray-400">Email</dt>
                    <dd class="mt-1 text-sm font-medium text-gray-800 dark:text-white/90">{{ $user->email }}</dd>
                </div>
                <div>
                ...
                <div>
                    ...
                    <dd class="mt-1 text-sm font-medium text-gray-800 dark:text-white/90">{{ $user->created_at?->format('d/m/Y H:i') }}</dd>
                </div>
            </dl>
        </div>
    </div>
