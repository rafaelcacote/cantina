...
@section('content')
    <div class="space-y-6">
        <div class="flex items-center justify-between">
            <h1 class="text-xl font-semibold text-gray-800 dark:text-white/90">Detalhes do Fiado</h1>
            <div class="flex gap-2">
                <a href="{{ route('admin.student-tabs.edit', $tab) }}" class="rounded-lg bg-brand-500 px-4 py-2 text-sm font-medium text-white hover:bg-brand-600">Editar</a>
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
            <dl class="grid grid-cols-1 gap-5 md:grid-cols-2">
                ...
                <div><dt class="text-xs uppercase text-gray-500">Ciclo</dt><dd class="mt-1 text-sm text-gray-800 dark:text-gray-200">{{ $tab->billing_cycle_type }}</dd></div>
