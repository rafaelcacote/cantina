    ...
    <div class="mx-auto max-w-3xl space-y-6">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-2">
                <a href="{{ route('admin.student-parents.edit', $studentParent) }}"
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
            <dl class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                <div><dt class="text-xs uppercase tracking-wide text-gray-500 dark:text-gray-400">Tenant</dt><dd class="mt-1 text-sm font-medium text-gray-800 dark:text-white/90">{{ $studentParent->tenant?->name ?? '-' }}</dd></div>
