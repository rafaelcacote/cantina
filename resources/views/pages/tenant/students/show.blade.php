    ...
    <div class="mx-auto max-w-4xl space-y-6">
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
            <dl class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div class="sm:col-span-2"><dt class="text-xs uppercase tracking-wide text-gray-500 dark:text-gray-400">Foto URL</dt><dd class="mt-1 break-all text-sm font-medium text-gray-800 dark:text-white/90">{{ $student->photo_url ?? '-' }}</dd></div>
