    ...
    <div class="mx-auto max-w-3xl space-y-6">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            ...
            <div class="flex flex-wrap items-center gap-2">
                <a href="{{ route('tenant.daily-menus.show', $dailyMenu) }}"
        ...
        <form method="POST" action="{{ route('tenant.daily-menus.update', $dailyMenu) }}" class="overflow-hidden rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]" novalidate>
            @csrf
            @method('PUT')
