...
@section('content')
    <div class="mx-auto max-w-3xl space-y-6"
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
            <p class="text-xs font-semibold uppercase tracking-wide text-gray-500">Link do responsável</p>
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
            ...
            <form method="POST" action="{{ route('tenant.parent-invitations.toggle', $invitation) }}" class="mt-6">
                @csrf
                @method('PATCH')
                <button type="submit"
