...
@section('content')
    ...
    <div class="mx-auto max-w-3xl space-y-6">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('tenant.parent-invitations.index') }}" class="text-sm font-medium text-brand-600">Voltar</a>
        </div>
        ...
        <div class="rounded-2xl border border-brand-100 bg-brand-50/70 px-5 py-4 text-sm text-gray-700 dark:border-brand-500/20 dark:bg-brand-500/10 dark:text-gray-300">
            O responsável abre o link no celular, cria a conta e já cadastra os filhos. Os alunos entram como
            <strong>pendentes</strong> para a cantina conferir.
        </div>

        <form method="POST" action="{{ route('tenant.parent-invitations.store') }}" novalidate
            ...
            <div class="flex justify-end gap-3">
                <a href="{{ route('tenant.parent-invitations.index') }}"
