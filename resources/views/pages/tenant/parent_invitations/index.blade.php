        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    Gere um link para o responsável criar o acesso e cadastrar os filhos.
                </p>
            </div>
                    ...
                    @forelse($invitations as $invitation)
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-3 text-right">
                                <a href="{{ route('tenant.parent-invitations.show', $invitation) }}"
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-4 py-10 text-center text-sm text-gray-500 dark:text-gray-400">
                                Nenhum convite ainda. Gere um link para enviar aos responsáveis.
                            </td>
                        </tr>
                    @endforelse
                    </tbody>
