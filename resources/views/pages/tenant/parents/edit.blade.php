...
@section('content')
    <div class="mx-auto max-w-3xl space-y-6">
        ...
        <form method="POST" action="{{ route('tenant.parents.update', $parent) }}" class="overflow-hidden rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]" novalidate>
            @csrf
            @method('PUT')
