        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    Responsável: <span class="font-medium text-gray-700 dark:text-gray-300">{{ $parent->name }}</span>
                </p>
            </div>
            <div class="flex flex-wrap items-center gap-2">
                ...
                <a href="{{ route('tenant.student-parents.create', ['parent_id' => $parent->id]) }}"
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-800">
                    ...
                    @forelse($links as $link)
                        <tr>
                            ...
                            <td class="px-4 py-3 text-sm text-gray-600 dark:text-gray-300">{{ $link->student?->school?->name ?? '-' }}</td>
