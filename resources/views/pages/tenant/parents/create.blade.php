...
@section('content')
    <div class="mx-auto max-w-3xl space-y-6">
        ...
        <form method="POST" action="{{ route('tenant.parents.store') }}" class="space-y-5 rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
            @csrf
