                ...
                @forelse ($order->items as $item)
                    <tr>
                        ...
                        <td class="px-4 py-3 text-sm">
                            <div class="space-y-2">
                                <form method="POST" action="{{ route('tenant.orders.items.update', [$order, $item]) }}" class="grid grid-cols-1 gap-2 lg:grid-cols-6">
                                    @csrf
                                    @method('PUT')
                                ...
                                <form method="POST" action="{{ route('tenant.orders.items.destroy', [$order, $item]) }}">
                                    @csrf
                                    @method('DELETE')
