    ...
    <div class="mx-auto max-w-5xl space-y-6">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Cadastre um novo pedido da cantina.</p>
            </div>
        ...
        <form method="POST" action="{{ route('tenant.orders.store') }}" class="overflow-hidden rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]" novalidate>
            @csrf
            <div class="space-y-5 p-6">
                @include('pages.tenant.orders.partials.form')
            </div>
