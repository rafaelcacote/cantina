    ...
    <div class="space-y-6">
            ...
            <div class="flex flex-col gap-5 p-5 lg:flex-row lg:items-center lg:justify-between lg:px-6">
                ...
                @if (! $isCancelled)
                    <div class="flex shrink-0 flex-col gap-2 sm:items-end"
                        ...
                        @if ($nextStatus)
                            <form method="POST"
                                  action="{{ route('operator.orders.status.update', $order) }}"
        ...
        <div class="flex flex-col gap-6 xl:flex-row">
            <div class="min-w-0 flex-[1.7] space-y-6">
                @include('pages.operator.orders.partials.items')
                ...
                <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                    ...
                    <div class="space-y-4 p-5">
                        <div class="flex items-center gap-3">
                            ...
                            <div class="min-w-0">
                                @if ($order->student)
                                    <a href="{{ route('operator.students.show', $order->student) }}"
                        ...
                        <dl class="space-y-3">
                            <div class="flex items-start justify-between gap-3">
                                ...
                                <dd class="text-right text-sm font-medium text-gray-800 dark:text-white/90">{{ $order->school?->name ?? '—' }}</dd>
                            </div>
                            <div class="flex items-start justify-between gap-3">
                                <dt class="text-xs uppercase tracking-wide text-gray-500 dark:text-gray-400">Responsável</dt>
                                <dd class="text-right text-sm font-medium text-gray-800 dark:text-white/90">{{ $order->parent?->name ?? '—' }}</dd>
                            </div>
                            <div class="flex items-start justify-between gap-3">
