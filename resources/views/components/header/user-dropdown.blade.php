...
<div class="relative" x-data="{
    ...
    <button
        class="flex items-center rounded-lg px-2 py-1.5 text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-white/5"
        @click.prevent="toggleDropdown()"
        type="button"
    >
       <span class="block mr-1 font-medium text-theme-sm">{{ $user?->name ?? 'Usuário' }}</span>
    ...
    >
        <div>
            <span class="block font-medium text-gray-700 text-theme-sm dark:text-gray-400">{{ $user?->name ?? 'Usuário' }}</span>
