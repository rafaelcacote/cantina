...
class MenuHelper
{
        ...
        if (in_array($user->user_type, ['tenant_admin', 'manager'], true)) {
            return [
                ...
                [
                    ...
                    'name' => 'Financeiro',
                    'subItems' => [
                        ['name' => 'Carteiras', 'path' => '/tenant/student-wallets'],
                        ['name' => 'Recargas Pix', 'path' => '/tenant/wallet-topups'],
                        ['name' => 'Extrato', 'path' => '/tenant/wallet-transactions'],
                        ['name' => 'Fiados', 'path' => '/tenant/student-tabs'],
                        ['name' => 'Lançamentos', 'path' => '/tenant/tab-entries'],
                        ['name' => 'Pagamentos', 'path' => '/tenant/payments'],
                    ],
                ],
                [
                    'icon' => 'authentication',
                    ...
                    'subItems' => [
                        ['name' => 'Controles', 'path' => '/tenant/parental-controls'],
                        ['name' => 'Categorias Permitidas', 'path' => '/tenant/parental-allowed-categories'],
                        ['name' => 'Produtos Bloqueados', 'path' => '/tenant/parental-blocked-products'],
                    ],
                ],
                [
                    'icon' => 'chat',
                    'name' => 'Sistema',
                    'subItems' => [
                        ['name' => 'Autorizações PIN', 'path' => '/tenant/purchase-authorizations'],
                        ['name' => 'Notificações', 'path' => '/tenant/notifications'],
                        ['name' => 'Auditoria', 'path' => '/tenant/audit-logs'],
                    ],
                ],
            ];
        }
        ...
        if ($user->user_type === 'super_admin') {
            $items[] = [
                ...
                'subItems' => [
                    ...
                    ['name' => 'Assinaturas', 'path' => '/admin/subscriptions'],
                    ['name' => 'Convites', 'path' => '/admin/tenant-invitations'],
                    ['name' => 'Operadores', 'path' => '/admin/operators'],
                ],
            ];
            $items[] = [
                'icon' => 'user-profile',
            ...
            $items[] = [
                ...
                'name' => 'Financeiro',
                'subItems' => [
                    ['name' => 'Carteiras', 'path' => '/admin/student-wallets'],
                    ['name' => 'Extrato', 'path' => '/admin/wallet-transactions'],
                    ['name' => 'Fiados', 'path' => '/admin/student-tabs'],
                    ['name' => 'Lançamentos', 'path' => '/admin/tab-entries'],
            ...
            $items[] = [
                ...
                'name' => 'Controle Parental',
                'subItems' => [
                    ['name' => 'Controles', 'path' => '/admin/parental-controls'],
                    ['name' => 'Categorias Permitidas', 'path' => '/admin/parental-allowed-categories'],
                    ['name' => 'Produtos Bloqueados', 'path' => '/admin/parental-blocked-products'],
                    ['name' => 'Pedidos Pré-definidos', 'path' => '/admin/parental-preselected-orders'],
                    ['name' => 'Autorizações PIN', 'path' => '/admin/purchase-authorizations'],
                ],
            ];
            $items[] = [
                'icon' => 'chat',
                ...
                'subItems' => [
                    ...
                    ['name' => 'Auditoria', 'path' => '/admin/audit-logs'],
                ],
            ];
        }
    ...
    public static function getIconSvg($iconName)
    {
        $icons = [
            ...
            'student' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M11.386 3.2108C11.7627 3.02181 12.2102 3.02181 12.5869 3.2108L21.3369 7.5858C21.9018 7.86966 22.1481 8.55735 21.8642 9.12221C21.6755 9.49896 21.3064 9.74291 20.9001 9.78085V14.75C20.9001 15.1642 20.5643 15.5 20.1501 15.5C19.7359 15.5 19.4001 15.1642 19.4001 14.75V10.5332L17.9001 11.2832V16.0431C17.9001 16.5335 17.6472 16.9871 17.2296 17.2443L12.7296 20.0157C12.2789 20.2933 11.6941 20.2933 11.2435 20.0157L6.74346 17.2443C6.32585 16.9871 6.07297 16.5335 6.07297 16.0431V11.2832L2.63599 9.5647C2.07113 9.28084 1.82485 8.59315 2.10871 8.02829C2.20472 7.83709 2.35679 7.68114 2.54549 7.5858L11.386 3.2108ZM7.57297 12.1482L11.2435 13.9836C11.6941 14.2612 12.2789 14.2612 12.7296 13.9836L16.4001 12.1482V15.7003L12.0001 18.4095L7.57297 15.7003V12.1482ZM12.0001 4.60101L4.40769 8.39721L12.0001 12.1934L19.5654 8.39721L12.0001 4.60101Z" fill="currentColor"></path></svg>',

            'parent' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M8.25 7.5C8.25 5.98122 9.48122 4.75 11 4.75C12.5188 4.75 13.75 5.98122 13.75 7.5C13.75 9.01878 12.5188 10.25 11 10.25C9.48122 10.25 8.25 9.01878 8.25 7.5ZM11 3.25C8.65279 3.25 6.75 5.15279 6.75 7.5C6.75 9.84721 8.65279 11.75 11 11.75C13.3472 11.75 15.25 9.84721 15.25 7.5C15.25 5.15279 13.3472 3.25 11 3.25ZM5.01172 16.875C5.01172 15.3562 6.24294 14.125 7.76172 14.125H14.2383C15.7571 14.125 16.9883 15.3562 16.9883 16.875V18.25C16.9883 18.6642 17.3241 19 17.7383 19C18.1525 19 18.4883 18.6642 18.4883 18.25V16.875C18.4883 14.5278 16.5855 12.625 14.2383 12.625H7.76172C5.41451 12.625 3.51172 14.5278 3.51172 16.875V18.25C3.51172 18.6642 3.84751 19 4.26172 19C4.67593 19 5.01172 18.6642 5.01172 18.25V16.875ZM16.5 8.75C15.5335 8.75 14.75 9.5335 14.75 10.5C14.75 11.4665 15.5335 12.25 16.5 12.25C17.4665 12.25 18.25 11.4665 18.25 10.5C18.25 9.5335 17.4665 8.75 16.5 8.75ZM13.25 10.5C13.25 8.70507 14.7051 7.25 16.5 7.25C18.2949 7.25 19.75 8.70507 19.75 10.5C19.75 12.2949 18.2949 13.75 16.5 13.75C14.7051 13.75 13.25 12.2949 13.25 10.5ZM19.75 17.25C19.75 16.8358 20.0858 16.5 20.5 16.5H21.5C21.9142 16.5 22.25 16.8358 22.25 17.25C22.25 17.6642 21.9142 18 21.5 18H20.5C20.0858 18 19.75 17.6642 19.75 17.25ZM20.5 14.25C18.9812 14.25 17.75 15.4812 17.75 17C17.75 17.4142 17.4142 17.75 17 17.75C16.5858 17.75 16.25 17.4142 16.25 17C16.25 14.6528 18.1528 12.75 20.5 12.75H21.5C21.9142 12.75 22.25 13.0858 22.25 13.5C22.25 13.9142 21.9142 14.25 21.5 14.25H20.5Z" fill="currentColor"></path></svg>',
            ...
            'school' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M12 2.25C11.7929 2.25 11.5934 2.32095 11.4331 2.45096L3.68306 8.70096C3.40326 8.9268 3.25 9.26684 3.25 9.625V19.75C3.25 20.3023 3.69772 20.75 4.25 20.75H9.75C10.3023 20.75 10.75 20.3023 10.75 19.75V15.25C10.75 14.9739 10.9739 14.75 11.25 14.75H12.75C13.0261 14.75 13.25 14.9739 13.25 15.25V19.75C13.25 20.3023 13.6977 20.75 14.25 20.75H19.75C20.3023 20.75 20.75 20.3023 20.75 19.75V9.625C20.75 9.26684 20.5967 8.9268 20.3169 8.70096L12.5669 2.45096C12.4066 2.32095 12.2071 2.25 12 2.25ZM4.75 9.91046L12 4.06046L19.25 9.91046V19.25H14.75V15.25C14.75 14.1454 13.8546 13.25 12.75 13.25H11.25C10.1454 13.25 9.25 14.1454 9.25 15.25V19.25H4.75V9.91046ZM11.25 7.5C11.25 7.08579 11.5858 6.75 12 6.75H12.008C12.4222 6.75 12.758 7.08579 12.758 7.5C12.758 7.91421 12.4222 8.25 12.008 8.25H12C11.5858 8.25 11.25 7.91421 11.25 7.5ZM7.75 11.5C7.75 11.0858 8.08579 10.75 8.5 10.75H8.508C8.92221 10.75 9.258 11.0858 9.258 11.5C9.258 11.9142 8.92221 12.25 8.508 12.25H8.5C8.08579 12.25 7.75 11.9142 7.75 11.5ZM14.75 11.5C14.75 11.0858 15.0858 10.75 15.5 10.75H15.508C15.9222 10.75 16.258 11.0858 16.258 11.5C16.258 11.9142 15.9222 12.25 15.508 12.25H15.5C15.0858 12.25 14.75 11.9142 14.75 11.5Z" fill="currentColor"></path></svg>',
